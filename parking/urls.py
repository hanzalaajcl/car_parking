...
from .views import GetVehicleModelbyTypeView,CreateParkingPlazaView,GetVehicleTypeView,ParkingVehicleCheckInView,GetParkingPlazaView,ParkingVehicleCheckOutView
